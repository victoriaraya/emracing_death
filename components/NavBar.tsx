...
const NavBar = () => {
  ...
  return (
    <nav
      className={`${notoSansEthiopic.className} relative text-[#CDBA9D] bg-[#2c393a] md:h-32 h-16`}
    >
      ...
      >
        <li className="relative group">
          ...
          <span className="absolute left-1/2 bottom-[-3px] w-0 h-[2px] bg-[#CDBA9D] transition-all duration-300 group-hover:w-full group-hover:left-0"></span>
        </li>
        <li className="relative group">
