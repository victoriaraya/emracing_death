    ...
    <div className="flex flex-col gap-3">
      ...
      <p>
        <p>
          ...
          of life plans ahead, ensures that your wishes are respected, providing
          clear guidance and reducing the potential for family conflicts and
          alleviates the burden on the loved ones during an emotionally
          challenging time. Making an end of life arrangement plan helps
          prevents unexpected financial burdens on the loved onesand knowing
          that you have a plan in place can bring peace of mind to you and your
          family.
        </p>
        <br />
        <p>
          Many people have not thought about the arrangement of end of life and
          feel overwhelmed about where to start the process. I hope to help ease
          some of the most common questions and unsurety while caring for a
          loved one who is going through the ding process.
        </p>{" "}
        <br />{" "}
        <p>
          ...
          very elderly, I help them develop a personalized plan about what would
      ...
      <p>
        <p>
          ...
          loved ones. Through personal experiences of over 15 years as a hospice
          and palliative care nurse, I have come to understand the importance of
          hollistic care and the need for compassionate guidance during this
        ...
        <p>
          ...
          expanded curiosity about what is possible for end-of-life care. Making
          a formal plan to help the guess work out of what you want and
          communicating that with your loved ones may actually alleviate some of
          the stress that comes with death; like funeral plans, body disposition
          and even what outfit you want to wear.{" "}
        </p>{" "}
        <br />{" "}
        <p>
